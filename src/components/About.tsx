...
const About = () => {
  ...
  return (
    <section ref={ref} className="py-20 bg-white dark:bg-gradient-to-b dark:from-slate-900 dark:to-slate-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className={`text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-white ${inView ? 'animate-slide-up' : 'opacity-0'}`}>
            About <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Ignivance</span>
          </h2>
        ...
        <div className="md:hidden space-y-6 px-4">
          <div className={`${inView ? 'animate-slide-up' : 'opacity-0'}`} style={{ animationDelay: '0.1s' }}>
            <div className="bg-white dark:bg-slate-800/50 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-slate-600">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="text-center p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl border border-gray-100 dark:border-slate-600">
        ...
        <div className="hidden md:grid md:grid-cols-3 gap-8">
          <div className={`${inView ? 'animate-slide-up' : 'opacity-0'}`}>
            <div className="bg-white dark:bg-slate-800/50 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-slate-600 h-full">
